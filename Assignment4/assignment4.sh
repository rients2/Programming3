...
seq 25 2 31 | parallel -j16 velveth ${folder}{} {} -fastq -separate -longPaired ${file1} ${file2}
seq 25 2 31 | parallel -j16 velvetg ${folder}{}

seq 25 2 31 | python3 assignment4.py -kmar {} >> output/kmars.csv
